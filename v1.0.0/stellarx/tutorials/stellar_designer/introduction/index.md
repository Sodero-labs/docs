...
Now that the basic introduction is complete, let's proceed to the [next page](https://docs.sodero.io/v1.0.0/stellarx/tutorials/stellar_designer/robot_structure/index.md) and start building a robot.
