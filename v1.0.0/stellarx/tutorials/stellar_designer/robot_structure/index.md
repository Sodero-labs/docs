...
Your `test_robot` is now ready for simulation or control tasks. Proceed to [Step 2: Robot System Parameters](https://docs.sodero.io/v1.0.0/stellarx/tutorials/stellar_designer/configure_system_parameters/index.md) to configure the global robot parameters.
